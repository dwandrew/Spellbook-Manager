...
API.new
    ...
    def seed_list_monsters
        ...
        monsters["results"].each do |monster|
            ...
            proficiencies: monster_info["proficiencies"] ? monster_info["proficiencies"].map {|prof| "#{prof["proficiency"]["name"]}:" + " +#{prof["value"]}"}.join(" <br><br>") : nil,
    ...
    def seed_profile
        new_user = User.new(username: "Test", password: "Password1!")
        new_user.save
    end
